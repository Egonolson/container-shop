...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "@id": "https://containerdienst-seyfarth.de/#business",
      name: "Seyfarth Container-Dienst",
      url: "https://containerdienst-seyfarth.de/",
    ...
    {
      "@type": "WebSite",
      "@id": "https://containerdienst-seyfarth.de/#website",
      name: "Seyfarth Container-Dienst",
      url: "https://containerdienst-seyfarth.de/",
    },
    {
      "@type": "Service",
      "@id": "https://containerdienst-seyfarth.de/#containerdienst",
      name: "Container online anfragen",
      serviceType: "Containerdienst, Entsorgung, Baustofflieferung und Transport",
      provider: { "@id": "https://containerdienst-seyfarth.de/#business" },
      areaServed: "Altenburger Land und Umgebung",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://containerdienst-seyfarth.de/#faq",
...
export default function HomePage() {
  return (
    <PublicShell>
      ...
      <section className="hidden bg-[#F3F7FB] py-24 md:block">
